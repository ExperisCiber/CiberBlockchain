...
const sandboxId = 'd406b0eba3';
const url = 'https://mhulshof.by.ether.camp:8555/sandbox/' + sandboxId;
const web3 = new Web3(new Web3.providers.HttpProvider(url));

web3.eth.defaultAccount = '0xdedb49385ad5b94a16f236a6890cf9e0b1e30392';

const contract = web3.eth.contract(abi).at('0x17956ba5f4291844bc25aedb27e69bc11b5bda39');
